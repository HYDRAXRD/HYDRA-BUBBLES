...
const Index = () => {
  ...
  const filtered = useMemo(() => {
    ...
    // On 30d view (default/home), only show tokens that gained in the last 30 days
    if (filter === "30d" && !search.trim()) {
      tokens = tokens.filter((t) => getChange(t, "30d") > 0);
      // Sort by 30d gain descending
      tokens = [...tokens].sort((a, b) => getChange(b, "30d") - getChange(a, "30d"));
    }
